...
class UVSimGUI:
    def __init__(self, master):
        ...
        self.memory_frame = tk.Frame(master, padx=10, pady=10)
        ...
        self.accumulator_label = tk.Label(self.main_frame, text="Accumulator: 0", font=("Arial", 12))
        self.accumulator_label.pack()


        self.output_display = tk.Label(self.main_frame, text="Output: ", font=("Arial", 12))
